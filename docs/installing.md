...
without needing to work with config files or a command line. This page covers getting
it installed and running - see [Using pyopia-gui](usage.md) for what to do once it's up.
